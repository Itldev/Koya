...
public class SharingWrapper {
    ...
    public SharingWrapper(List<SecuredItem> sharedItems, List<String> usersMails, String serverPath, String acceptUrl, String rejectUrl, String directAccessUrl) {
        this(sharedItems, usersMails, Boolean.FALSE, serverPath, acceptUrl, rejectUrl, directAccessUrl);
    }
