...
public class CompanyServiceImpl extends AlfrescoRestService implements CompanyService {
     ...
     */
    @Override
    public Company create(User admin, Company c) throws RestClientException, AlfrescoServiceException {
        ...
        ItlAlfrescoServiceWrapper ret = admin.getRestTemplate().getForObject(getAlfrescoServerUrl() + REST_POST_ADDCOMPANY + "/" + c.getTitle() + "/" + c.getCurrentSaleOffer().getName(), ItlAlfrescoServiceWrapper.class);
