 ...
 */
public class AfterValidateInvitePostActivityActionExecuter extends KoyaNotifierActionExecuter {
    ...
    protected void executeImpl(Action action, final NodeRef actionedUponNodeRef) {
        ...
        User user = userService.getUserByUsername(authenticationService.getCurrentUserName());
