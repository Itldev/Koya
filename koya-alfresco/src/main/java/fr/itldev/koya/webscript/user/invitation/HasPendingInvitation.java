 ...
 */
package fr.itldev.koya.webscript.user.invitation;
 ...
 *
 */
public class HasPendingInvitation extends AbstractWebScript {
    ...
    public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException {
        ...
        try {
            ...
            response = companyAclService.hasPendingInvitation(c, u).toString();
